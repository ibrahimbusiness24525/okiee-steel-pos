...
export const api = {
  ...
  getSaleReturns: () => smartFetch(`${API}/sale-returns`, {headers:authHeaders()}).then(async r => { const d = await r.json().catch(()=>({})); return { ...d, _status: r.status, message: d.message || (r.status===404?"Route not found":d.message) }; }),
  addSaleReturn:  (d) => smartFetch(`${API}/sale-returns`, {method:"POST",headers:authHeaders(),body:JSON.stringify(d)}).then(async r => { const b = await r.json().catch(()=>({})); return { ...b, _status: r.status, success: b.success === true, message: b.message || (r.status===404?"Route not found":b.message) }; }),
  deleteSaleReturn:(id) => smartFetch(`${API}/sale-returns/${id}`,{method:"DELETE",headers:authHeaders()}).then(async r => { const b = await r.json().catch(()=>({})); return { ...b, _status: r.status, success: b.success === true, message: b.message || (r.status===404?"Route not found":b.message) }; }),
  getPurchaseReturns: () => smartFetch(`${API}/purchase-returns`, {headers:authHeaders()}).then(async r => { const d = await r.json().catch(()=>({})); return { ...d, _status: r.status, message: d.message || (r.status===404?"Route not found":d.message) }; }),
  addPurchaseReturn:  (d) => smartFetch(`${API}/purchase-returns`,{method:"POST",headers:authHeaders(),body:JSON.stringify(d)}).then(async r => { const b = await r.json().catch(()=>({})); return { ...b, _status: r.status, success: b.success === true, message: b.message || (r.status===404?"Route not found":b.message) }; }),
  deletePurchaseReturn:(id) => smartFetch(`${API}/purchase-returns/${id}`,{method:"DELETE",headers:authHeaders()}).then(async r => { const b = await r.json().catch(()=>({})); return { ...b, _status: r.status, success: b.success === true, message: b.message || (r.status===404?"Route not found":b.message) }; }),
  ...
  adjustAccount: (id,d) => smartFetch(`${API}/accounts/${id}/adjust`,{method:"POST",headers:authHeaders(),body:JSON.stringify(d)}).then(async r => { const b = await r.json().catch(()=>({})); return { ...b, success: b.success === true, message: b.message || (r.ok ? b.message : "Account not updated") }; }),
  ...
  getExpenses:    () => smartFetch(`${API}/expenses`, {headers:authHeaders()}).then(async r => { const d = await r.json().catch(()=>({})); return { ...d, _status: r.status, message: d.message || (r.status===404?"Route not found":d.message) }; }),
  addExpense:     (d) => smartFetch(`${API}/expenses`,{method:"POST",headers:authHeaders(),body:JSON.stringify(d)}).then(async r => { const b = await r.json().catch(()=>({})); return { ...b, _status: r.status, success: b.success === true, message: b.message || (r.status===404?"Route not found":b.message) }; }),
  updateExpense:  (id,d) => smartFetch(`${API}/expenses/${id}`,{method:"PUT",headers:authHeaders(),body:JSON.stringify(d)}).then(async r => { const b = await r.json().catch(()=>({})); return { ...b, _status: r.status, success: b.success === true, message: b.message || (r.status===404?"Route not found":b.message) }; }),
  deleteExpense:  (id) => smartFetch(`${API}/expenses/${id}`,{method:"DELETE",headers:authHeaders()}).then(async r => { const b = await r.json().catch(()=>({})); return { ...b, _status: r.status, success: b.success === true, message: b.message || (r.status===404?"Route not found":b.message) }; }),
  getExpenseTypes:() => smartFetch(`${API}/expenses/types`, {headers:authHeaders()}).then(async r => { const d = await r.json().catch(()=>({})); return { ...d, _status: r.status, message: d.message || (r.status===404?"Route not found":d.message) }; }),
  addExpenseType: (d) => smartFetch(`${API}/expenses/types`,{method:"POST",headers:authHeaders(),body:JSON.stringify(d)}).then(async r => { const b = await r.json().catch(()=>({})); return { ...b, _status: r.status, success: b.success === true, message: b.message || (r.status===404?"Route not found":b.message) }; }),
  updateExpenseType:(id,d) => smartFetch(`${API}/expenses/types/${id}`,{method:"PUT",headers:authHeaders(),body:JSON.stringify(d)}).then(async r => { const b = await r.json().catch(()=>({})); return { ...b, _status: r.status, success: b.success === true, message: b.message || (r.status===404?"Route not found":b.message) }; }),
  deleteExpenseType:(id) => smartFetch(`${API}/expenses/types/${id}`,{method:"DELETE",headers:authHeaders()}).then(async r => { const b = await r.json().catch(()=>({})); return { ...b, _status: r.status, success: b.success === true, message: b.message || (r.status===404?"Route not found":b.message) }; }),
